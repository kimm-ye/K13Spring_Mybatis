...
<body>
<div class="container">
	<h3 class="text-center">방명록 게시판(한줄게시판)</h3>
	...
	<div class="text-right">
		<!-- 
			...
			속성이 있는지 확인함.
			단, 영역에 저장딘 속성명이 유일할 경우
			내장객체는 생략할 수 있으므로 필수사항은 아니다.
		 -->
		<c:choose>
			<%-- <c:when test="${not empty siteUserInfo }"> 로도 작성할 수 있다.--%>
			<c:when test="${not empty sessionScope.siteUserInfo }">
				<!-- 세션영역에 속성이 잇을때, 즉 로그인이 되었을때 -->
