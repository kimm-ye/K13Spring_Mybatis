...
<meta charset="UTF-8">
<title>modify</title>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css">cript>
</head>
<body>
...
<div class="container">
	...
	<form name="writeFrm" method="post" onsubmit="return writeValidate(this);" action="<c:url value="/mybatis/modifyAction.do" />" >	
